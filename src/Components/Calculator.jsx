...
function Calculator() {
    ...
    return (
            <div className="bg-gray-950 text-white w-screen h-screen flex justify-center items-center">
                <div className="w-64 h-auto bg-stone-950 rounded-2xl shadow-xl border-4 border-gray-100">
                    ...
                    <div className="keyboard">
                        <div className="m-2 flex justify-between">
                            <input type="button" onClick={clearScreen} value="C" className="bg-gray-600 shadow-md rounded-lg w-12 h-12 text-center text-white font-medium flex justify-center items-center outline-none" onClickCapture={clickHandle} />
